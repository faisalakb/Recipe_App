  ...
  describe 'POST #create' do
    context 'with valid attributes' do
      it 'creates a new inventory' do
        expect do
          post :create, params: { inventory: FactoryBot.attributes_for(:inventory), user: user }
    ...
    context 'with invalid attributes' do
      it 'does not create a new inventory' do
        expect do
          post :create, params: { inventory: FactoryBot.attributes_for(:inventory, name: nil), user: user }
